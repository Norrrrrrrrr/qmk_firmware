...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT( /* Base */
    ...
    KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     XXXXXXX, XXXXXXX,  XXXXXXX,
    KC_H,     AL_J,     GU_K,     CT_L,     SF_SC,    XXXXXXX, XXXXXXX,  XXXXXXX,
    KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  XXXXXXX, XXXXXXX,  XXXXXXX,
    RAI_ENT,  KC_NO  ,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_BSPC, XXXXXXX,  XXXXXXX,
    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX, XXXXXXX,  XXXXXXX,
    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX, XXXXXXX,  XXXXXXX
  ),
  ...
  [_LOWER] = LAYOUT(
    ...
    KC_CIRC,  KC_AMPR,  KC_ASTR,  KC_LPRN,  KC_RPRN,  XXXXXXX,  XXXXXXX,  XXXXXXX,
    XXXXXXX,  KC_UNDS,  KC_PLUS,  KC_DQT,   KC_PIPE,  XXXXXXX,  XXXXXXX,  XXXXXXX,
    XXXXXXX,  KC_MINS,  KC_EQL,   KC_QUOT,  KC_BSLS,  XXXXXXX,  XXXXXXX,  XXXXXXX,
    KC_ENT ,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  _______,  XXXXXXX,  XXXXXXX,
    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX
  ),
  ...
  [_LOWER2] = LAYOUT(
    ...
    KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     XXXXXXX,  XXXXXXX,  XXXXXXX,
    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   XXXXXXX,  XXXXXXX,  XXXXXXX,
    KC_ASTR,  KC_SLSH,  KC_COMM,  KC_DOT,   KC_EQL,   XXXXXXX,  XXXXXXX,  XXXXXXX,
    KC_ENT,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  _______,  XXXXXXX,  XXXXXXX,
    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX
  ),
  ...
  [_RAISE] = LAYOUT(
    ...
    XXXXXXX,  KC_HOME,  KC_PGDN,  KC_PGUP,  KC_END,   XXXXXXX,  XXXXXXX,  XXXXXXX,
    KC_LANG1, KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  XXXXXXX,  XXXXXXX,  XXXXXXX,
    KC_APP,   KC_BSPC, S(KC_TAB), KC_TAB,   KC_DEL,   XXXXXXX,  XXXXXXX,  XXXXXXX,
    RAI_ENT,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  _______,  XXXXXXX,  XXXXXXX,
  ...
  [_ADJUST] = LAYOUT(
    ...
    XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_PSCR,  KC_INS ,  XXXXXXX,  XXXXXXX,  XXXXXXX,
    XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_SLCK,  KC_PAUS,  XXXXXXX,  XXXXXXX,  XXXXXXX,
    KC_ENT,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  _______,  XXXXXXX,  XXXXXXX,
    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX
