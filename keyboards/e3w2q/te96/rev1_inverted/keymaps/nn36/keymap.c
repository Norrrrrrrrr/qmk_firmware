...
`------+------+------+------+------+------.  ,------+------+------+------+------+------'
  ...
  [_LOWER] = LAYOUT_nn36(
    ...
    KC_ESC,  KC_TILD, KC_LCBR, KC_RCBR, KC_BTN1,       XXXXXXX, KC_UNDS, KC_PLUS, KC_DQT,  KC_PIPE,
    XXXXXXX, KC_GRV,  KC_LBRC, KC_RBRC, KC_BTN2,       XXXXXXX, KC_MINS, KC_EQL,  KC_QUOT, KC_BSLS,
