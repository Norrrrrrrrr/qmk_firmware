...
`-----------------------------------------'  `-----------------------------------------'
  ...
  [_LOWER2] = LAYOUT(
      ...
      _______, KC_F11,  KC_F12,  KC_BTN2, KC_BTN3, KC_BTN1,       XXXXXXX, XXXXXXX, KC_COMM, KC_DOT,  XXXXXXX, KC_PLUS,
...
`-----------------------------------------'  `-----------------------------------------'
  ...
  [_RAISE] = LAYOUT(
      ...
      _______, KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, XXXXXXX,       KC_APP,  KC_BSPC,S(KC_TAB),KC_TAB,  KC_DEL,  XXXXXXX,
...
`-----------------------------------------'  `-----------------------------------------'
   */
    [_ADJUST] =  LAYOUT(
      ...
      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,       XXXXXXX, XXXXXXX, XXXXXXX, KC_SLCK, KC_PAUS, XXXXXXX,
