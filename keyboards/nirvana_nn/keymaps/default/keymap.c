...
`-----------------------------------------'  `-----------------------------------------'
  ...
  [_LOWER] = LAYOUT( \
      ...
      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, LOW_SPC, _______,                  KC_BRCSET,KC_ENT,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX \
      ),
...
`-----------------------------------------'  `-----------------------------------------'
  ...
  [_RAISE] = LAYOUT( \
      ...
      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_SPC,  _______,                   KC_BSPC, RAI_ENT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX \
      ),
...
`-----------------------------------------'  `-----------------------------------------'
   */
    [_ADJUST] =  LAYOUT( \
      ...
      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_SPC,  _______,                   KC_BSPC, KC_ENT,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX\
      )
};
