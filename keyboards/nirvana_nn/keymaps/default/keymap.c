...
`-----------------------------------------'  `-----------------------------------------'
  ...
  [_BASE] = LAYOUT(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, LOW_SPC, KC_BSPC,       KC_LSFT, RAI_ENT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),
...
`-----------------------------------------'  `-----------------------------------------'
  ...
  [_LOWER] = LAYOUT(
    ...
    _______, KC_ESC,  KC_GRV,  KC_BSLS, KC_QUOT, KC_F11,        KC_F12,  KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,
    _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,         KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_PLUS,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, LOW_SPC, _______,       _______, KC_ADJ,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),
...
`-----------------------------------------'  `-----------------------------------------'
  ...
  [_RAISE] = LAYOUT(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_SPC,  _______,       _______, RAI_ENT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),
